// Simulation code for RC generated by the OpenModelica Compiler 1.7.0 (r9040).
...
const struct omc_varInfo algvars_names[10] = {
  {1002,"der(C1.v)","Voltage drop between the two pins (= p.v - n.v)",{"/usr/lib/omlibrary/msl31/Modelica/Electrical/Analog/Interfaces.mo",178,5,178,67,1}},
  {1003,"R1.v","Voltage drop between the two pins (= p.v - n.v)",{"/usr/lib/omlibrary/msl31/Modelica/Electrical/Analog/Interfaces.mo",178,5,178,67,1}},
  {1004,"R1.LossPower","Loss power leaving component via HeatPort",{"/usr/lib/omlibrary/msl31/Modelica/Electrical/Analog/Interfaces.mo",326,5,327,50,1}},
  {1005,"C1.p.i","Current flowing into the pin",{"/usr/lib/omlibrary/msl31/Modelica/Electrical/Analog/Interfaces.mo",51,5,56,61,1}},
  {1006,"G.p.i","Current flowing into the pin",{"/usr/lib/omlibrary/msl31/Modelica/Electrical/Analog/Interfaces.mo",13,5,18,61,1}},
  {1007,"s","",{"ReteRC.mo",11,2,11,18,0}},
  {1008,"C1.n.v","Potential at the pin",{"/usr/lib/omlibrary/msl31/Modelica/Electrical/Analog/Interfaces.mo",89,5,94,61,1}},
  {1009,"G.p.v","Potential at the pin",{"/usr/lib/omlibrary/msl31/Modelica/Electrical/Analog/Interfaces.mo",7,5,12,61,1}},
  {1010,"E.n.v","Potential at the pin",{"/usr/lib/omlibrary/msl31/Modelica/Electrical/Analog/Interfaces.mo",89,5,94,61,1}},
  {1011,"R1.R_actual","Actual resistance = R*(1 + alpha*(T_heatPort - T_ref))",{"/usr/lib/omlibrary/msl31/Modelica/Electrical/Analog/Basic.mo",76,3,77,63,1}}
};
...
#define $PG$Pp$Pi__varInfo algvars_names[4]
#define $Ps__varInfo algvars_names[5]
#define $PC1$Pn$Pv__varInfo algvars_names[6]
#define $PG$Pp$Pv__varInfo algvars_names[7]
...
const struct omc_varInfo param_names[9] = {
  {1012,"R1.T","Fixed device temperature if useHeatPort = false",{"/usr/lib/omlibrary/msl31/Modelica/Electrical/Analog/Interfaces.mo",321,5,322,99,1}},
  {1013,"R1.R","Resistance at temperature T_ref",{"/usr/lib/omlibrary/msl31/Modelica/Electrical/Analog/Basic.mo",68,3,69,40,1}},
  {1014,"R1.T_ref","Reference temperature",{"/usr/lib/omlibrary/msl31/Modelica/Electrical/Analog/Basic.mo",70,3,70,78,1}},
  {1015,"R1.alpha","Temperature coefficient of resistance (R_actual = R*(1 + alpha*(T_heatPort - T_ref))",{"/usr/lib/omlibrary/msl31/Modelica/Electrical/Analog/Basic.mo",71,3,72,93,1}},
  {1016,"C1.C","Capacitance",{"/usr/lib/omlibrary/msl31/Modelica/Electrical/Analog/Basic.mo",320,5,320,54,1}},
  {1017,"SOGLIA","",{"ReteRC.mo",7,2,7,27,0}},
...
#define $PSOGLIA__varInfo param_names[5]
...
const struct omc_varInfo alias_names[15] = {
  {1021,"R1.i","Current flowing from pin p to pin n",{"/usr/lib/omlibrary/msl31/Modelica/Electrical/Analog/Interfaces.mo",179,5,179,55,1}},
  {1022,"R1.p.i","Current flowing into the pin",{"/usr/lib/omlibrary/msl31/Modelica/Electrical/Analog/Interfaces.mo",51,5,56,61,1}},
  {1023,"R1.T_heatPort","Temperature of HeatPort",{"/usr/lib/omlibrary/msl31/Modelica/Electrical/Analog/Interfaces.mo",328,5,328,70,1}},
  {1024,"C1.i","Current flowing from pin p to pin n",{"/usr/lib/omlibrary/msl31/Modelica/Electrical/Analog/Interfaces.mo",179,5,179,55,1}},
  {1025,"C1.n.i","Current flowing into the pin",{"/usr/lib/omlibrary/msl31/Modelica/Electrical/Analog/Interfaces.mo",95,5,100,61,1}},
  {1026,"C1.p.v","Potential at the pin",{"/usr/lib/omlibrary/msl31/Modelica/Electrical/Analog/Interfaces.mo",45,5,50,61,1}},
  {1027,"E.v","Voltage between pin p and n (= p.v - n.v) as input signal",{"/usr/lib/omlibrary/msl31/Modelica/Electrical/Analog/Sources.mo",13,5,18,26,1}},
  {1028,"E.i","Current flowing from pin p to pin n",{"/usr/lib/omlibrary/msl31/Modelica/Electrical/Analog/Sources.mo",19,5,19,55,1}},
  {1029,"E.n.i","Current flowing into the pin",{"/usr/lib/omlibrary/msl31/Modelica/Electrical/Analog/Interfaces.mo",95,5,100,61,1}},
  {1030,"E.p.v","Potential at the pin",{"/usr/lib/omlibrary/msl31/Modelica/Electrical/Analog/Interfaces.mo",45,5,50,61,1}},
  {1031,"R1.n.i","Current flowing into the pin",{"/usr/lib/omlibrary/msl31/Modelica/Electrical/Analog/Interfaces.mo",95,5,100,61,1}},
  {1032,"R1.n.v","Potential at the pin",{"/usr/lib/omlibrary/msl31/Modelica/Electrical/Analog/Interfaces.mo",89,5,94,61,1}},
  {1033,"E.p.i","Current flowing into the pin",{"/usr/lib/omlibrary/msl31/Modelica/Electrical/Analog/Interfaces.mo",51,5,56,61,1}},
  {1034,"R1.p.v","Potential at the pin",{"/usr/lib/omlibrary/msl31/Modelica/Electrical/Analog/Interfaces.mo",45,5,50,61,1}},
  {1035,"C1.v","Voltage drop between the two pins (= p.v - n.v)",{"/usr/lib/omlibrary/msl31/Modelica/Electrical/Analog/Interfaces.mo",178,5,178,67,1}}
};
...
const struct omc_varInfo bool_param_names[1] = {
  {1036,"R1.useHeatPort","=true, if HeatPort is enabled",{"/usr/lib/omlibrary/msl31/Modelica/Electrical/Analog/Interfaces.mo",319,5,320,80,1}}
};
...
#define $PG$Pp$Pi localData->algebraics[4]
#define $P$old$PG$Pp$Pi localData->algebraics_old[4]
#define $P$old2$PG$Pp$Pi localData->algebraics_old2[4]
#define $P$PRE$PG$Pp$Pi localData->algebraics_saved[4]
#define $Ps localData->algebraics[5]
#define $P$old$Ps localData->algebraics_old[5]
#define $P$old2$Ps localData->algebraics_old2[5]
#define $P$PRE$Ps localData->algebraics_saved[5]
#define $PC1$Pn$Pv localData->algebraics[6]
#define $P$old$PC1$Pn$Pv localData->algebraics_old[6]
#define $P$old2$PC1$Pn$Pv localData->algebraics_old2[6]
#define $P$PRE$PC1$Pn$Pv localData->algebraics_saved[6]
#define $PG$Pp$Pv localData->algebraics[7]
#define $P$old$PG$Pp$Pv localData->algebraics_old[7]
#define $P$old2$PG$Pp$Pv localData->algebraics_old2[7]
#define $P$PRE$PG$Pp$Pv localData->algebraics_saved[7]
...
#define $PSOGLIA localData->parameters[5]
#define $P$old$PSOGLIA localData->parameters_old[5]
#define $P$old2$PSOGLIA localData->parameters_old2[5]
#define $P$PRE$PSOGLIA localData->parameters_saved[5]
...
const struct omc_varInfo *equationInfo_cref7 = &$PG$Pp$Pi__varInfo;
const struct omc_varInfo *equationInfo_cref9 = &$P$DER$PC1$Pv__varInfo;
const struct omc_varInfo *equationInfo_cref11 = &$P$DER$PCOND1__varInfo;
const int nEquation = 13;
const struct omc_equationInfo equation_info[13] = {
  ...
  {1050,"SES_SIMPLE_ASSIGN 11",1,&equationInfo_cref11},
  {1051,"SES_ALGORITHM 12",0,NULL}
};
...
{
  if (&$PCOND1 == ptr) return state_names[0].name;
  if (&$P$DER$PCOND1 == ptr) return derivative_names[0].name;
  if (&$P$DER$PC1$Pv == ptr) return algvars_names[0].name;
  if (&$PR1$Pv == ptr) return algvars_names[1].name;
  if (&$PR1$PLossPower == ptr) return algvars_names[2].name;
  if (&$PC1$Pp$Pi == ptr) return algvars_names[3].name;
  if (&$PG$Pp$Pi == ptr) return algvars_names[4].name;
  if (&$Ps == ptr) return algvars_names[5].name;
  if (&$PC1$Pn$Pv == ptr) return algvars_names[6].name;
  if (&$PG$Pp$Pv == ptr) return algvars_names[7].name;
  if (&$PE$Pn$Pv == ptr) return algvars_names[8].name;
  if (&$PR1$PR_actual == ptr) return algvars_names[9].name;
  if (&$PR1$PT == ptr) return param_names[0].name;
  if (&$PR1$PR == ptr) return param_names[1].name;
  if (&$PR1$PT_ref == ptr) return param_names[2].name;
  if (&$PR1$Palpha == ptr) return param_names[3].name;
  if (&$PC1$PC == ptr) return param_names[4].name;
  if (&$PSOGLIA == ptr) return param_names[5].name;
  if (&$PREACT1 == ptr) return param_names[6].name;
  if (&$PR == ptr) return param_names[7].name;
  if (&$PC == ptr) return param_names[8].name;
  return "";
}
...
{
  if (&$PR1$PuseHeatPort == ptr) return bool_param_names[0].name;
  return "";
}
...
int bound_parameters()
{
  ...
  $PC1$PC = $PC; 
  /*#modelicaLine [/usr/lib/omlibrary/msl31/Modelica/Electrical/Analog/Interfaces.mo:321:5-322:99]*/
  if (!($PR1$PT >= 0.0)) {
    omc_fileInfo info = {"/usr/lib/omlibrary/msl31/Modelica/Electrical/Analog/Interfaces.mo",321,5,322,99,1};
    MODELICA_ASSERT(info, "Variable R1.T out of limit");
  }
  /*#endModelicaLine*/
  /*#modelicaLine [/usr/lib/omlibrary/msl31/Modelica/Electrical/Analog/Basic.mo:70:3-70:78]*/
  if (!($PR1$PT_ref >= 0.0)) {
    omc_fileInfo info = {"/usr/lib/omlibrary/msl31/Modelica/Electrical/Analog/Basic.mo",70,3,70,78,1};
    MODELICA_ASSERT(info, "Variable R1.T_ref out of limit");
  }
  /*#endModelicaLine*/
  /*#modelicaLine [/usr/lib/omlibrary/msl31/Modelica/Electrical/Analog/Basic.mo:320:5-320:54]*/
  if (!($PC1$PC >= 0.0)) {
    omc_fileInfo info = {"/usr/lib/omlibrary/msl31/Modelica/Electrical/Analog/Basic.mo",320,5,320,54,1};
...
int functionAliasEquations()
{
  ...
  mem_state = get_memory_state();
  /*#modelicaLine [/usr/lib/omlibrary/msl31/Modelica/Electrical/Analog/Basic.mo:79:3-79:108]*/
  RELATIONTOZC(tmp1052, (1.0 + ($PR1$Palpha * ($PR1$PT - $PR1$PT_ref))), 1e-15, -1,GreaterEq,>=);
  if (!tmp1052) {
    omc_fileInfo info = {"/usr/lib/omlibrary/msl31/Modelica/Electrical/Analog/Basic.mo",79,3,79,108,1};
...
int functionDAE(int *needToIterate)
{
  ...
  *needToIterate = 0;
  ...
  SAVEZEROCROSS(tmp1055, $PCOND1, $PSOGLIA, 1,Greater,>);
  localData->helpVars[1] = tmp1055;
  SAVEZEROCROSS(tmp1054, $PCOND1, $PSOGLIA, -1,LessEq,<=);
  localData->helpVars[2] = tmp1054;
  if (localData->helpVars[1] && !localData->helpVars_saved[1] /* edge */) {
    /*#modelicaLine [ReteRC.mo:32:3-32:11]*/
    $Ps = 1.0;
    /*#endModelicaLine*/
  }
  else if (localData->helpVars[2] && !localData->helpVars_saved[2] /* edge */) {
    /*#modelicaLine [ReteRC.mo:34:3-34:11]*/
    $Ps = 0.0;
    /*#endModelicaLine*/
  }
  /*#endModelicaLine*/
  /*#modelicaLine [ReteRC.mo:37:4-39:12]*/
  localData->helpVars[0] = ($Ps != $P$PRE$Ps);
  if (localData->helpVars[0] && !localData->helpVars_saved[0] /* edge */) {
    /*#modelicaLine [ReteRC.mo:38:7-38:31]*/
    #ifdef _OMC_MEASURE_TIME
    SIM_PROF_TICK_FN(FilePrint_index);
    #endif
    _FilePrint($Ps, $P$PRE$Ps, time);
    #ifdef _OMC_MEASURE_TIME
...
int function_onlyZeroCrossings(double *gout,double *t)
{
  ...
  mem_state = get_memory_state();
  ZEROCROSSING(0, LessEq($PCOND1, $PSOGLIA));
  ZEROCROSSING(1, Greater($PCOND1, $PSOGLIA));
  restore_memory_state(mem_state);
...
int checkForDiscreteChanges()
{
  ...
  if ($Ps != $P$PRE$Ps) { if (sim_verbose >= LOG_EVENTS) { printf("Discrete Var s : %g to %g\n", $P$PRE$Ps, $Ps); }  needToIterate=1; }
...
int checkForAsserts()
{
  ...
  /*#modelicaLine [/usr/lib/omlibrary/msl31/Modelica/Electrical/Analog/Basic.mo:79:3-79:108]*/
  SAVEZEROCROSS(tmp1056, (1.0 + ($PR1$Palpha * ($PR1$PT - $PR1$PT_ref))), 1e-15, -1,GreaterEq,>=);
  if (!tmp1056) {
    omc_fileInfo info = {"/usr/lib/omlibrary/msl31/Modelica/Electrical/Analog/Basic.mo",79,3,79,108,1};
    MODELICA_ASSERT(info, "Temperature outside scope of model!");
  }
