 ...
 *
 */
public class NuZotSystemConnector implements SystemConnector {

	protected Clock clock;
	protected Logger logger;
	protected NuZotWrapper wrapper;
	
	protected SystemMemento systemMemento;
	
	public NuZotSystemConnector(Logger logger) {
		this.logger = logger;
	}
	...
	public SystemMemento initialize(
		...
		wrapper = new NuZotWrapper(systemPath, systemName,
